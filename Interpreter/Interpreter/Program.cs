...
/*Notes:
 * add lolcat
 * add size warning for read
 * make size warning for read based on a line in settings
 * add piping algorithem
 */
...
namespace Interpreter
{
    class Program
    {
        ...
        {
            string path = @"" + dir + "\\c" + R.Next(1,3).ToString() + ".txt";
